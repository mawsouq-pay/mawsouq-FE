...
export const arTexts = {
	title: "الثقة هي أساس كل عملية دفع",
	description:
		"موثوق هو وصيتك المضمون. بيحجز الفلوس لحد ما العميل يستلم طلبه، ويتتبع كل خطوة. بعد ما يستلم، الفلوس توصلك بأمان.",
	cta: "جرّب موثوق مجانًا",
};
